...
1. Discuss potential project topics:
   ...
   - Whether the dose of vaccine affects the microbiome structure of recipients independent of the antibody response category?
   - Do IgA-only and IgG-only responders have distinct microbiomes? (differences in mucosal and humoural immunity)
   ...
   - Can microbiome profiles be used to predict age?
   - Do infants with higher WLZ (weight-for-length Z score) or WAZ (weight-for-age Z score) show accelerated microbiome maturation/greater microbiome diversity? Can also look into other categories related to growth.
   - Is infant gut microbiome composition associated with appetite scores?
